...
from atmpy.physics.eos import ExnerBasedEOS  # Ensure this EOS is suitable for Sod's problem
from atmpy.variables.variables import Variables
from atmpy.data.enums import VariableIndices as VI, SlopeLimiters, RiemannSolvers, FluxReconstructions
...
def steady_state():
    dim = [DimensionSpec(1, 0, 2, 2),
           DimensionSpec(2, 0, 2, 2)]
    ...
    print(flux.flux["x"][..., VI.RHO])  # the variable rho of the flux container is rho*u.
