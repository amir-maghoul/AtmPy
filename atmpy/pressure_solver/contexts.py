...
if TYPE_CHECKING:
    from atmpy.infrastructure.enums import PressureSolvers, DiscreteOperators, LinearSolvers
...
from atmpy.infrastructure.factory import get_pressure_solver, get_discrete_operators, get_linear_solver
...
class PSInstantiationContext:
    ...
    def __init__(self,
        ...
        self.op_context = op_context  # instance of the DCInstantiationContext (e.g., ndim and dxyz)
...
def example_usage():
    ...
    pressure_solver_instance = ps_context.factor()
